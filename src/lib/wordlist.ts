...
export const WORDLIST: readonly string[] = [
  ...
  'blush','board','boat','body','boil','bomb','bone','book','boost','border',
  ...
  'child','chimney','choice','choose','chronic','chuckle','chunk','cigar','cinnamon','circle',
  ...
  'keep','ketchup','key','kick','kid','kingdom','kiss','kit','kitchen','kite',
  'kitten','kiwi','knee','knife','knock','know','lab','ladder','lamp','language',
  ...
  'lunar','lunch','luxury','mad','magic','magnet','maid','main','mammoth','man',
  ...
  'meadow','mean','medal','media','melody','melt','member','memory','mention','menu',
  ...
  'model','modify','mom','monitor','monkey','monster','month','moon','moral','more',
  ...
  'mystery','naive','name','napkin','narrow','nasty','nature','near','neck','need',
  'negative','neglect','neither','nephew','nerve','nest','network','news','next','nice',
  'night','noble','noise','nominee','noodle','normal','north','notable','note','nothing',
  'notice','novel','now','nuclear','number','nurse','nut','oak','obey','object',
  'oblige','obscure','obtain','ocean','october','odor','off','offer','often','oil',
  ...
  'ostrich','other','outdoor','outside','oval','over','own','oyster','ozone','pact',
  ...
  'provide','public','pudding','pull','pulp','punch','pupil','purchase','purity','purpose',
  ...
  'review','reward','rhythm','ribbon','rid','ride','ridge','rifle','right','rigid',
  ...
  'sample','sand','satisfy','satoshi','sauce','sausage','save','scale','scan','scatter',
  ...
  'social','sock','solar','soldier','solid','solution','solve','someone','song','soon',
  'sorry','soul','sound','soup','source','south','space','spare','spatial','spawn',
  ...
  'very','veteran','viable','vibrant','vicious','victory','video','view','village','vintage',
  ...
  // Supplemental words to reach exactly 2048 (custom recovery system)
  'ace','acre','aid','ale','arid','arson','aura','azure','bane','baron',
  'bask','baton','beam','bias','blaze','bliss','blot','bolt','boon','bore',
  'brace','brew','brim','brood','brow','cache','calf','cane','cape','carve',
  'cedar','cent','chant','cheer','chide','chime','chord','civic','cleft','cloak',
  'clone','clot','clove','cob','colt','cone','cope','cork','count','cramp',
  'crave','crimp','crow','crud','cue','curl','dale','dame','dare','darn',
  'daze','deem','dent','dew','dip','dire','disk','ditch','dote','drab',
  'dram','drape','drove','dub','duke','dull','dusk','earl','fang','fare',
  'fawn','fend','fern','feud','flair','flank','flap','flaw','foe','fond',
  'fore','foul','fowl','fray','gale','gall','garb','gash','gawk','gill',
  'gist','gloat','gnaw','goad','gore','graft','grim','gripe','groan','haze',
  'hemp','herd','hoax','hovel','howl','husk','knack','knave','kneel','knelt',
  'knob','lace','lad','lair','lame','lank','lard',
] as const;
